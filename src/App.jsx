    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-5xl md:text-7xl font- mb-6 bg-gradient-to-r from-green via-blue-100 to-cyan-100 bg-clip-text text-transparent">
            Banking for the Future
          </h2>
          <p className="text-xl md:text-2xl text-slate-300 mb-8 max-w-3xl mx-auto">
            Experienc financial freedom with Metro's cutting-edge digital banking platform
          </p>
          <button className="group px-8 py-4 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-b00 hover:to-cyan-600 transition-all text-lg font-semibold inline-flex items-center">
